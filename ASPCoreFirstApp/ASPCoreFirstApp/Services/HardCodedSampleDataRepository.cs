...
namespace ASPCoreFirstApp.Services
{
    public class HardCodedSampleDataRepository : IProductDataService
    {
        ...
        {
            productList.Add(new ProductModel(1, "Mouse Pad", 5.99m, "A square piece of plastic to make" +
                    "mousing easier"));
            productList.Add(new ProductModel(2, "Web Cam", 45.50m, "Enables you to attend more Zoom meetings"));
            productList.Add(new ProductModel(3, "4 TB USB Hard Drive", 130.00m, "Back up all of your" +
                "work. You won't regret it."));
            productList.Add(new ProductModel(4, "Wireless Mouse", 15.99m, "Notbook mice really don't work very well." +
                "Do they?"));
            for (int i = 0; i < 100; i++)
            {
